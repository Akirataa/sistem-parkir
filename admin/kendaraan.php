                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <a class="badge badge-danger float-right ml-1" onclick="return confirm('Terimakasih telah parkir di bakti idhata jumlah yang harus anda bayar = <?php ?>');" href="../config/kendaraan/do_hapus.php?id=<?= $kendaraan['id']; ?>">Hapus</a>
